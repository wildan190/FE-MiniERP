              ...
              <div class="space-y-1">
                ...
                <template v-if="activeModule === 'hrm'">
                  <div class="pt-2 pb-2">
                    ...
                    <!-- Claims Section -->
                    <div class="px-3 mb-2 mt-6">
                      <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest pl-1">Claims</p>
                    </div>

                    <RouterLink
                      to="/hrm/reimbursements"
                      @click="isMobileSidebarOpen = false"
                      class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all"
                      :class="route.path.startsWith('/hrm/reimbursements') ? 'bg-primary-50 text-primary-600 shadow-sm' : 'text-gray-600 hover:bg-gray-50'"
                    >
                      <div class="flex items-center gap-3">
                        <Banknote class="h-5 w-5" />
