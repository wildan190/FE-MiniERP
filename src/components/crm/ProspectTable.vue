      ...
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody v-if="loading">
          <tr v-for="i in 5" :key="i" class="border-b border-gray-100">
            <td class="px-6 py-4 whitespace-nowrap"><Skeleton width="12rem" height="1.25rem" /></td>
            <td class="px-6 py-4 whitespace-nowrap">
              <Skeleton width="10rem" height="1rem" customClass="mb-1" />
              <Skeleton width="6rem" height="0.75rem" />
            </td>
            <td class="px-6 py-4 whitespace-nowrap"><Skeleton width="5rem" height="1.25rem" borderRadius="9999px" /></td>
            <td class="px-6 py-4 whitespace-nowrap"><Skeleton width="8rem" height="1.25rem" /></td>
            <td class="px-6 py-4 whitespace-nowrap"><Skeleton width="6rem" height="1rem" /></td>
            <td class="px-6 py-4 whitespace-nowrap"><Skeleton width="6rem" height="1rem" /></td>
